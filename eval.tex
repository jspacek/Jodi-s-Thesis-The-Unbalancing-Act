...
% show that the reason that uniform random enumerates slower than POD
% is because the load is unbalanced, 

% TODO another graph to show ? what is missing? mybae some numbers, rather than graphs? or linking back to the theorems at least about bystanders? 
